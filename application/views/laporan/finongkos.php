...
<body>
<?php echo $this->load->view('header'); $i = $no; $ctlr = "laporan/finongkos"; ?>
<h4 class="text-center text-success"><?php echo $success; ?></h4>
<div class="container-fluid">
<div class="tab-content">
<div class="table-responsive">
   <table class="table table-hover">
    <caption><?php echo 'Laporan Ongkos Finishing '.$nama.' dari '.$start.' sampai dengan '.$stop; ?></caption>
    <thead>
      <tr>
         ...
         <th class='success'><?php echo anchor($ctlr . '/0/tanggal/'.$order, 'Tgl.Setor', 'title="Urutkan Tgl.Setor"'); ?></th>
         <th class='warning'><?php echo anchor($ctlr . '/0/jmlsetor/'.$order, 'Jml.Setor', 'title="Urutkan Jml.Setor"'); ?></th>
         <th class='success'><?php echo anchor($ctlr . '/0/ongkos/'.$order, 'Harga Finishing', 'title="Urutkan Harga Finishing"'); ?></th>
