...
class Laporan extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->load->database();
        $this->load->helper(['form', 'url', 'url_helper', 'csv_helper']);
        $this->load->model(['main_model', 'cut_model', 'fin_model', 'sew_model', 'item_model', 'jenis_model', 'pekerja_model','toleransi_model','laporan_model  ']);
